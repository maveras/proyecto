...
request1 = Request.create!(user:user2,interest:interest2,description:"me gustaria jugar al futbol juan",day_time:d1, state_request:1, location:"mi casa", date_end:d2, title:"tituloooo")
request2 = Request.create!(user:user2,interest:interest2,description:"me gustaria jugar al futbol marceliuno",day_time:d1, state_request:1, location:"mi casa", date_end:d2, title:"tituloooo")

request3 = Request.create!(user:user3,interest:interest1,description:"me gustaria jugar al Basketball",day_time:d1, state_request:1, location:"mi casa", date_end:d2, title:"tituloooo")
request4 = Request.create!(user:user4,interest:interest3,description:"me gustaria ir a correr pedro",day_time:d1, state_request:1, location:"mi casa", date_end:d2, title:"tituloooo")
request5 = Request.create!(user:user4,interest:interest3,description:"me gustaria trotar perdro",day_time:d1, state_request:1, location:"mi casa", date_end:d2, title:"tituloooo")
request6 = Request.create!(user:user1,interest:interest1,description:"me gustaria jugar a las bolitas",day_time:d1, state_request:1, location:"mi casa", date_end:d2, title:"tituloooo")
